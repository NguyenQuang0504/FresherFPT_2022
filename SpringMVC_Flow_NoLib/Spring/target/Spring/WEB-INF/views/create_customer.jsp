                ...
                <div style="padding-top: 30px">
                    ...
                    <form:form method="post" action="/customer/create" modelAttribute="customer" >
                        <div class="form-group">
                            ...
                            <form:input path="maKH" type="text" class="form-control" placeholder="Nhập mã khách hàng" />
                            <i style="color: red"><form:errors path="maKH"></form:errors></i>
                        </div>
                        <div class="form-group">
                            <label>Tên khách hàng</label>
                            <form:input type="text" class="form-control" path="tenKH" placeholder="Nhập tên khách hàng"/>
                            <i style="color: red"><form:errors path="tenKH"></form:errors></i>
                        </div>
                        <div class="form-group">
                            <label>Địa chỉ</label>
                            <form:input type="text" class="form-control" path="diaChi" placeholder="Nhập địa chỉ"/>
                            <i style="color: red"><form:errors path="diaChi"></form:errors></i>

                        </div>
                        <div class="form-group">
                            <label>Số điện thoại</label>
                            <form:input type="text" class="form-control phone" path="sdt" id="phone"  placeholder="Nhập số điện thoại"/>
                            <i style="color: red"><form:errors path="sdt"></form:errors></i>
                        </div>
                        <div class="form-group">
                            <label>Email</label>
                            <form:input type="text" id="email" class="form-control" path="email" placeholder="Nhập email"/>
                            <i style="color: red"><form:errors path="email"></form:errors></i>
                        </div>
