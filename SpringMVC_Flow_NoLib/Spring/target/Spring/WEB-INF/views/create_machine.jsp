        ...
        <div class="col-lg-9">
            ...
            <div class="container">
                <div style="padding-top: 30px">
                    <h5 style="text-align: center">Thêm mới máy</h5>
                    <i style="color: red"><c:out value="${message}"/></i>
                    <form:form method="post" modelAttribute="machine" action="/machine/save">
                        <div class="form-group">
                            <label>Mã máy</label>
                            <form:input type="text" class="form-control" path="maMay" placeholder="Nhập mã máy"/>
                            <i style="color: red"><form:errors path="maMay"></form:errors></i>

                        </div>
                        <div class="form-group">
                            <label>Vị trí</label>
                            <form:input type="text" class="form-control" path="viTri" placeholder="Nhập vị trí"/>
                            <i style="color: red"><form:errors path="viTri"></form:errors></i>

                        </div>
                        <div class="form-group">
                            <label>Trạng thái</label>
                            <form:input type="text" class="form-control" path="trangThai" placeholder="Nhập trạng thái"/>
                            <i style="color: red"><form:errors path="trangThai"></form:errors></i>
