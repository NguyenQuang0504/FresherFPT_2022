    ...
    <div class="row nav-left">
        ...
        <div class="col-lg-9">
            <div class="container" style="padding-top: 30px">
                <div>
                    <h5 style="text-align: center">Danh sách dịch vụ</h5>
                    <table class="table">
                        <thead>
                        <tr>
                        ...
                        <c:forEach items="${services}" var="service">
                            <tr>
                                ...
                                <td>${service.getDonVi()}</td>
                                <td>${service.getDonGia()}</td>
                                <td class="option">
                                    <a href="/service/update?id=${service.getMaDV()}">
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <a href="/service/delete?id=${service.getMaDV()}" type="button" class="btn btn-primary">Delete</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                ...
                <nav aria-label="Page navigation example">
                    <ul class="pagination">
                        <c:if test="${currentPage >1}">
                            <li class="page-item"><a class="page-link" href="/service/list?page=${currentPage-1}">Previous</a></li>
                        </c:if>
                        <c:forEach begin="1" end="${totalPage}" var="i" >
                            <c:choose>
                                <c:when test="${currentPage eq i}">
                                    <li class="page-item"><a class="page-link bg-success" href="/service/list?page=${i}">${i}</a></li>
                                </c:when>
                                <c:otherwise>
                                    <li class="page-item"><a class="page-link" href="/service/list?page=${i}">${i}</a></li>
                                </c:otherwise>
                            </c:choose>
                        </c:forEach>
                        <c:if test="${currentPage < totalPage}">
                            <li class="page-item"><a class="page-link" href="/service/list?page=${currentPage+1}">Next</a></li>
                        </c:if>
                    </ul>
                </nav>
            </div>
            <a href="/service/create" type="button" class="btn btn-success">Create</a>
        </div>
    </div>
