                ...
                <div style="padding-top: 30px">
                    ...
                    <form:form method="post" action="/useService/save" modelAttribute="useService">
                        <div class="form-group">
                            ...
                            <form:select path="customer.maKH" class="form-control">
                                <c:forEach var="customer" items="${customers}">
                                    <form:option value="${customer.maKH}" >${customer.getMaKH()}</form:option>
                                </c:forEach>
                            </form:select>
                        </div>
                        <div class="form-group">
                            ...
                            <form:select path="service.maDV" class="form-control">
                                <c:forEach var="service" items="${services}">
                                    <form:option value="${service.maDV}" >${service.getMaDV()}</form:option>
                                </c:forEach>
                            </form:select>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <form:input path="soLuong" type="number" class="form-control" placeholder="Nhập số lượng"/>
                        </div>
