	...
	<nav class="navbar navbar-expand-sm navbar-dark bg-dark"> <a class="navbar-brand" href="#"><i
		...
		<div id="navbarNavDropdown" class="navbar-collapse collapse">
			<ul class="navbar-nav mr-auto">
				<li class="nav-item"><a class="nav-link" href="/add-emp" id="addEmpLink">Add</a></li>
				<li class="nav-item"><a class="nav-link" id="listEmpsLink" href="/list-employees">List</a></li>
