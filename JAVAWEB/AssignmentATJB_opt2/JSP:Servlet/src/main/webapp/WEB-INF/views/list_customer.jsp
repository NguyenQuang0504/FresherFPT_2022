            ...
            <div class="container" style="padding-top: 30px">
                <div>
                    ...
                    <table class="table">
                        ...
                        <tbody>
                        <th:forEach items="${customers}" var="customer">
                            <tr>
                                <td><c:out value="${customer.getMaKH()}"/></td>
                                <td><c:out value="${customer.getTenKH()}"/></td>
                                <td><c:out value="${customer.getDiaChi()}"/></td>
                                <td><c:out value="${customer.getSdt()}"/></td>
                                <td><c:out value="${customer.getEmail()}"/></td>
                                <td class="option">
                                    <a href="/customer?action=update?id=${customer.getMaKH()}">
...
<%--                                    DELETE USE POPUP--%>
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <a href="/customer?action=delete&id=${customer.getMaKH()}" type="button" class="btn btn-primary">Delete</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
            ...
            <a href="/customer?action=add" type="button" class="btn btn-success">Create</a>
        </div>
    </div>
