...
<div class="container-fluid">
    ...
    <div class="row nav-left">
        ...
        <div class="col-lg-9">
                    ...
                    <table class="table">
                        ...
                        <th:forEach items="${machines}" var="machine">
                            <tr>
                                ...
                                <td class="option">
                                    <a href="/customer?action=update?id=${machine.getMaMay()}">
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <a href="/machine?action=delete&id=${machine.getMaMay()}" type="button" class="btn btn-primary">Delete</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
            ...
            <a href="/machine?action=add" type="button" class="btn btn-success">Create</a>
        </div>
    </div>
