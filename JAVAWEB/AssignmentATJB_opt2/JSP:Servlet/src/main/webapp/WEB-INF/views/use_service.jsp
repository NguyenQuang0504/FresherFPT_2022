        ...
        <div class="col-lg-9">
            ...
            <div class="container">
                <div style="padding-top: 30px">
                    <h5 style="text-align: center">Đăng ký sử dụng dịch vụ</h5>
                    <form method="post">
                        <div class="form-group">
                            <label>Mã KH</label>
                            <select name="maKH" class="form-control">
                                <c:forEach var="customer" items="${customers}">
                                    <option value="${customer.getMaKH()}" ><c:out value="${customer.getMaKH()}"/></option>
                                </c:forEach>
                            </select>
                        </div>
                        <div class="form-group">
                            ...
                            <select name="maDV" class="form-control">
                                <c:forEach var="service" items="${services}">
                                    <option value="${service.getMaDV()}" ><c:out value="${service.getMaDV()}"/></option>
                                </c:forEach>
                            </select>
                        </div>
                        <div class="form-group">
                            <label>Ngày sử dụng</label>
                            <input name="ngaySD" type="date" class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Giờ sử dụng</label>
                            <input name="gioSD" type="time" class="form-control">
                        </div>
                        <div class="form-group">
