                ...
                <form method="post">
                    <div class="form-group">
                        ...
                        <select name="maKH" class="form-control">
                            <c:forEach items="${customers}" var="maKH">
                                <option value="${maKH.getMaKH()}" ><c:out value="${maKH.getMaKH()}"/></option>
                            </c:forEach>
                        </select>
                    </div>
                    <div class="form-group">
                        ...
                        <select name="maMay" class="form-control">
                            <c:forEach items="${machines}" var="may">
                                <option value="${may.getMaMay()}" ><c:out value="${may.getMaMay()}"/></option>
                            </c:forEach>
                        </select>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input name="gioBD" type="time" class="form-control">
                    </div>
                    <div class="form-group">
                        <label>Thời gian sử dụng</label>
                        <input name="thoiGianSD" type="number" class="form-control" placeholder="Nhập thời gian sử dụng máy">
                    </div>
