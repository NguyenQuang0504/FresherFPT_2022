                ...
                <div style="padding-top: 30px">
                    ...
                    <form method="post">
                        <div class="form-group">
                            ...
                            <input type="text" id="maDV" class="form-control" name="maDV" placeholder="Nhập mã dịch vụ">
                            <i id="messageDV" style="color: red"></i>
                        </div>
                        <div class="form-group">
                            <label>Tên dịch vụ</label>
                            <input type="text" class="form-control" name="tenDV" placeholder="Nhập tên dịch vụ">
                        </div>
                        <div class="form-group">
